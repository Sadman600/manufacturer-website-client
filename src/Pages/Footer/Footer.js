...
const Footer = () => {
    return (
        <footer className="rounded-b-lg footer footer-center p-10 bg-primary text-white">
            <div>
                ...
                <p className="font-bold">
                    Garments Accessories Industries Ltd. <br />Providing reliable tech since 1992
                </p>
